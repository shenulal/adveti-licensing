  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "slide-out-x": { to: { opacity: "0", transform: "translateX(24px)" } },
        ...
        "gold-glow": {
          "0%, 100%": { boxShadow: "0 0 0 0 hsl(var(--gold-500) / 0)" },
          "50%": { boxShadow: "0 0 0 6px hsl(var(--gold-500) / 0.45), 0 8px 24px -6px hsl(var(--gold-500) / 0.55)" },
        },
        "pulse-soft": {
          "0%, 100%": { boxShadow: "0 0 0 0 hsl(var(--danger-600) / 0.4)" },
          "50%": { boxShadow: "0 0 0 8px hsl(var(--danger-600) / 0)" },
        },
        "confetti-fall": {
